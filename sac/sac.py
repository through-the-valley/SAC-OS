...
import env.microgrid_for_continuous as my_env
import pickle
...
class PolicyNetContinuous(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        ess_1 = torch.tanh(normal_sample[:, 4]).view(-1, 1)
        ess_2 = torch.tanh(normal_sample[:, 5]).view(-1, 1)
...
class SACContinuous:
    ...
    def __init__(self,actor_lr, critic_lr, alpha_lr, hidden_dim, num_episodes, batch_size):
        ...
        self.q_value_net_path = '../model/sac/critic/actor_lr_' + str(self.actor_lr) + '_critic_lr_' + \
                                str(self.critic_lr) + '.pth'
        self.policy_net_path = '../model/sac/actor/actor_lr_' + str(self.actor_lr) + '_critic_lr_' + \
                               str(self.critic_lr) + '.pth'

        self.return_list_path = '../list/sac/object/return_list.pickle'
        self.mv_return_list_path = '../list/sac/mv_object/mv_return_list.pickle'
        self.total_cost_list_path = '../list/sac/cost/total_cost_list.pickle'
        self.mv_total_cost_list_path = '../list/sac/mv_cost/mv_total_cost_list.pickle'
        self.self_balance_list_path = '../list/sac/self_balance/self_balance_list.pickle'
        self.mv_self_balance_list_path = '../list/sac/mv_self_balance/mv_self_balance_list.pickle'
        self.trade_list_path = '../list/sac/trade/trade_list.pickle'
        self.mv_trade_list_path = '../list/sac/mv_trade/trade_list.pickle'
    ...
    def train(self, show=True):
        ...
        self.mv_trade_list = mv_trade_list
