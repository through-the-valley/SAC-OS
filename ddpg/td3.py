...
class PolicyNet(torch.nn.Module):
    def __init__(self, state_dim, hidden_dim_1, hidden_dim_2, action_bound):
        ...
        self.fc_trade = torch.nn.Linear(hidden_dim_2, 1)
...
class TD3:
    ...
    def __init__(self, actor_lr, critic_lr, num_episodes, hidden_dim, batch_size):
        ...
        self.target_critic_1 = QValueNet(self.state_dim, self.hidden_dim, self.action_dim).to(self.device)
        self.critic_2 = QValueNet(self.state_dim, self.hidden_dim, self.action_dim).to(self.device)
        self.target_critic_2 = QValueNet(self.state_dim, self.hidden_dim, self.action_dim).to(self.device)
        ...
        self.q_value_net_path = '../model/td3/critic/actor_lr_' + str(self.actor_lr) + '_critic_lr_' + \
                                str(self.actor_lr) + '.pth'
        self.policy_net_path = '../model/sac/actor/actor_lr_' + str(self.actor_lr) + '_critic_lr_' + \
                               str(self.critic_lr) + '.pth'

        self.return_list_path = '../list/td3/object/return_list.pickle'
        self.mv_return_list_path = '../list/td3/mv_object/mv_return_list.pickle'
        self.total_cost_list_path = '../list/td3/cost/total_cost_list.pickle'
        self.mv_total_cost_list_path = '../list/td3/mv_cost/mv_total_cost_list.pickle'
        self.self_balance_list_path = '../list/td3/self_balance/self_balance_list.pickle'
        self.mv_self_balance_list_path = '../list/td3/mv_self_balance/mv_self_balance_list.pickle'
        self.trade_list_path = '../list/td3/trade/trade_list.pickle'
        self.mv_trade_list_path = '../list/td3/mv_trade/trade_list.pickle'
    ...
    def update(self, transition_dict):
        ...
        noise = torch.normal(torch.tensor(0.0), torch.tensor(1.0))
        ...
        if self.update_count % self.actor_update_frequency:
    ...
    def train(self, show=True):
        ...
        torch.save(self.critic_1.state_dict(), self.q_value_net_path)
